    ...
    @IBInspectable var setLightTheme: Bool {
        ...
        set {
            ...
            if _setLightTheme {
                ...
                self.titleTextAttributes = [NSFontAttributeName: UIFont(name: "NanumSquare", size: 24)!, NSForegroundColorAttributeName: UIColor(red: 247/255, green: 114/255, blue: 39/255, alpha: 1)]
