...
////        var couponTitle : (label: String?, content: String?)
////        var couponNo : (label: String?, content: String?)
////        var couponExpireDate : (label: String?, content: String?)
////        var couponURL : (label: String?, content: String?)
////        var originalText : [String]?
////    }
//    
//    func parsing(textFromClipboard: [String]) -> Coupon {
//        
////        var barcodeImg: UIImage?
////        var couponTitle: (label: String?, content: String?)
////        var couponNo: (label: String?, content: String?)
...
//        coupon.clipboard = textFromClipboard
//        
...
//                            
//                            if let barcode = coupon.barcode{
//                                coupon.barcode = barcode
//                                
//                                //바코드 이미지 생성해야함
//                                coupon.barcodeImage = barcodeGenerator(string: barcode)
//                            }
//                        }
//                    }
//                    //URL 찾기: 키워드 "http"
